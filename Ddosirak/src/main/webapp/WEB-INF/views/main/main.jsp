				...
				<div class="col-24 col-md-2">
					...
					<div class="card bg-none mb-7 mb-md-0">
						...
						<div class="card-img-top position-relative mx-auto"
							...
							<!-- Image -->
							<img class="img-fluid rounded-circle" src="jsb/imgs/dosirak.png"
								alt="...">
						</div>
						<!-- Body -->
						<div class="card-body text-center">
							<!-- Heading -->
							<h6 class="mb-4">${category.key}</h6>
						</div>
					</div>
				</div>
			</c:forEach>
			...
			<div class="container">
				<div class="row">
					<div class="col-12">
						...
						<!-- Heading -->
						<h2 class="mb-10 text-center">추천상품</h2>
							...
							<div class="card">
								<div class="card-img">
									...
									<img class="card-img-top"
										src="./jsb/assets/img/products/product-6.jpg" alt="...">
