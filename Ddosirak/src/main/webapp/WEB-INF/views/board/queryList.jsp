				...
				<c:choose>
					<c:when test="${board.category ne '공지사항'}">
						<tr>
							...
							<td><a
									href="queryInfo.do?bno=${board.boardNo }&page=${paging.page }&kerword=${keyword }&searchCondition=${searchCondition}">${board.boardTitle
									}</a></td>
...
<div class="row"><button class="col-sm-3" id="addBoard" onclick="location.href='addQForm.do'">글쓰기</button></div>
